...
describe("Circle ", () => {
  it("should render a square with the given color,text, and text color", () => {
    ...
    expect(renderedSVG).toEqual(
      `<circle cx="150" cy="100" r="80" fill="blue" /><text x="100" y="100" text-anchor="middle" fill="white">DMH</text>`
    );
  });
});
...
describe("Square ", () => {
  it("should render a square with the given color,text, and text color", () => {
    ...
    const renderedSVG = shape.render();
    expect(renderedSVG).toEqual(
      `<rect x="50" y="50" width="300" height="200" fill="blue" /><text x="100" y="130" text-anchor="middle" fill="white">DMH</text>`
    );
  });
});
...
describe("Triangle ", () => {
  it("should render a triangle with the given color,text, and text color", () => {
    ...
    const renderedSVG = shape.render();
    expect(renderedSVG).toEqual(
      `<polygon points="150,18 244,182 56,182" fill="blue" /><text x="150" y="150" text-anchor="middle" fill="white">DMH</text>`
    );
  });
});
